...
$(function () {
    ...
    var scene = new ScrollMagic.Scene({
        ...
        //  duration: "100%"
        reverse: true
    }).setClassToggle('.cuadroescondido', 'cuadrovisible').addTo(controller);
    ...
    var scene1 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.owl-slide-title', 'owl-slide-text-desaparecer').addTo(controller);
    ...
    var scene2 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.S1_linea1', 'S1_linea1-oculta').addIndicators().addTo(controller);
    ...
    var scene2_0 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.S1_linea0', 'S1_linea0-oculta').addIndicators().addTo(controller);
    ...
    var scene2 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.S1_linea2', 'S1_linea2-oculta').addIndicators().addTo(controller);
    ...
    var scene3 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.tabsempresa', 'tabsempresamostrar').addIndicators().addTo(controller);
    ...
    var scene4 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.lineaempresa', 'abrirlinea').addIndicators().addTo(controller);
    ...
    var scene4 = new ScrollMagic.Scene({
        ...
        triggerHook: 0.5,
        reverse: true
    }).setClassToggle('.button_slide', 'button_slide_mostrar').addIndicators().addTo(controller);
});
...
var $slides = $("#sliderprincipal .owl-slide");
...
$("#sliderprincipal").on("initialized.owl.carousel", function () {
    setTimeout(function () {
...
var $owlCarousel = $("#sliderprincipal").owlCarousel({
    items: 1,
    loop: true,
    nav: true
    /* navText: [
...
var btn_scrolldown = document.getElementById("btn_scrolldown");
var btn_scrollup = document.getElementById("btn_scrollup");
var cajahistoria = document.getElementById("textohistoria");
var scrollinicio = 0;
